...
class OptionsState extends FlxState
{
	...
	/**
	 * The user clicked on the back button - close our save object, and go back to the MenuState
	 */
	function clickBack()
	{
		FlxG.save.flush();
	...
	/**
	 * The user clicked on the down button for volume - we reduce the volume by 10% and update the bar
	 */
	...
	/**
	 * The user click on the up button for volume - we increase the volume by 10% and update the bar
	 */
